...
public class Questao2 {
	...
	Scanner leia = new Scanner(System.in);
		...
		if (senha1.length() < 6) {
			...
			System.out.print("Sua senha não atende aos requisitos de segurança com apenas " + (senha1.length()) + " caracteres. É necessário conter no minimo 6. Quantidade de caracteres que falta(m): " + (6 - senha1.length() + " caractere(s) \n"));
		}
		else {
