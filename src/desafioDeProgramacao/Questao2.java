...
public class Questao2 {
	...
	public static void main(String[] args) {
		...
		if (senha1.length() < 6) {
			...
			System.out.print("Sua senha n�o atende aos requisitos de seguran�a com apenas " + (senha1.length())
					+ " caracteres. � necess�rio conter no minimo 6. Quantidade de caracteres que falta(m): "
